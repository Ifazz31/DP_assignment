...
// Concrete Products: FireAsteroid, IronAsteroid, RockyAsteroid, SiliconAsteroid, SilverAsteroid, GoldAsteroid, CrystalAsteroid
class FireAsteroid implements AbstractAsteroid {
    public void show() {
        System.out.println("Fire Asteroid popped up");
    }
}
...
class SilverAsteroid implements AbstractAsteroid {
    public void show() {
        System.out.println("Silver Asteroid popped up");
    }
}
...
// Concrete Products: DynamicDebrisField, PersistentDebrisField, StaticDebrisField, ExplosiveDebrisField, MagneticDebrisField
